...
### 2. AI 효도 상담 (7단계 구조적 시스템, 3-4분)
```
AI: **CARE+ 효도상담사**입니다 💐
    부모님을 위한 보험 상담을 도와드리겠습니다.
    **총 7가지 질문**을 통해 맞춤 상담을 진행하겠습니다.

    먼저 **보험을 선물하실 분**을 알려주세요. 어머님인가요, 아버님인가요? 💐
...
1. **ConsultationChat.tsx** - AI 상담 채팅 (OpenAI 연동)
   ...
   - ✅ 실시간 진행률 표시 (1/7 → 7/7)
   - ✅ 자동 정보 추출 및 분류
   - ✅ 첫 답변 질문 금지 및 중복 메시지 차단
2. **ProductRecommendation.tsx** - 7개 필수 정보 기반 맞춤 추천
...
2. **🤖 AI 상담 시스템**: 7단계 구조적 질문 시스템 (반복 질문 완전 방지)
